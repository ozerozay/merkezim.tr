...
new class extends Component
{
    ...
    public function mount()
    {
        ...
        //$this->config_taksit_date['maxDate'] = Carbon::now()->format('Y-m-d');
...
?>
<div>
    <x-button label="Taksitlendir" wire:click="showForm" icon="o-plus" class="btn-outline btn-sm" responsive />
        ...
        <x-modal wire:model="show" title="Taksitlendir">
            <x-form wire:submit="save">
                ...
                <livewire:components.form.number_dropdown wire:model="taksit_sayi" label="Taksit Sayısı"
                    :branch="$taksit_sayi" :includeZero="false" :max="48" />
                <x-slot:actions>
