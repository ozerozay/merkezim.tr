            ...
            <x-collapse name="group1">
                ...
                <x-slot:content>
                    <x-form wire:submit="edit">
                        <livewire:components.form.date_time wire:key="date-xa-{{ Str::random(10) }}"
                                                            label="Satış Tarihi" wire:model="sale_date"/>
                        <livewire:components.form.date_time wire:key="date-sw-{{ Str::random(10) }}"
                                                            label="Son Kullanım Tarihi" wire:model="expire_date"/>
                        <livewire:components.form.staff_multi_dropdown wire:key="drawer-sale-mlti-{{Str::random(10)}}"
                                                                       wire:model="sale_staffs"/>
                        <livewire:components.form.sale_type_dropdown wire:key="drawer-sale-type-{{Str::random(10)}}"
