            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-row justify-between items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <h2 class="text-base font-bold">Kasa</h2>
                    </div>
                        ...
                        <div class="card-body p-2.5">
                            ...
                            <div class="grid grid-cols-3 gap-2 mt-2">
                                <div class="bg-base-200 rounded-lg p-2">
                                    <div class="text-xs opacity-50">Tahsilat</div>
                                    <div class="text-success text-sm font-medium">
                                        +{{ number_format($branch['tahsilat'], 2) }}₺
                                    </div>
                                </div>
                                <div class="bg-base-200 rounded-lg p-2">
                                    <div class="text-xs opacity-50">Ödeme</div>
                                    <div class="text-error text-sm font-medium">
                                        -{{ number_format($branch['odeme'], 2) }}₺
                                    </div>
                                </div>
                                <div class="bg-base-200 rounded-lg p-2">
                                    <div class="text-xs opacity-50">Bakiye</div>
                                    <div class="text-primary text-sm font-medium">
                                        {{ number_format($branch['bakiye'], 2) }}₺
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="flex items-center justify-between" gap-3>
                        ...
                        <div class="flex items-center gap-1.5">
                            <span class="text-success text-sm font-medium">
                                +{{ number_format(collect($branchesData)->sum('tahsilat'), 2) }}₺
                            </span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="text-error text-sm font-medium">
                                -{{ number_format(collect($branchesData)->sum('odeme'), 2) }}₺
                            </span>
                        </div>
                        <div class="flex items-center gap-1.5">
