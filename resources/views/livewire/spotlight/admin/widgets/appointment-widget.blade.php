            ...
            <div class="flex flex-col gap-2">
                ...
                <div class="flex flex-row justify-between items-center">
                    <div class="flex items-center gap-2">
                        ...
                        <h2 class="text-base font-bold">Randevular</h2>
                    </div>
                    ...
                    <div class="card bg-base-100 w-full">
                        <div class="card-body p-2.5">
                            ...
                            <div class="grid grid-cols-2 gap-2 mt-2">
                                <div class="bg-base-200 rounded-lg p-2 flex justify-between items-center">
                                    <div>
                                        <div class="text-xs opacity-50">Toplam</div>
                                ...
                                <div class="bg-base-200 rounded-lg p-2 flex justify-between items-center">
                                    <div>
                                        <div class="text-xs opacity-50">Tamamlanan</div>
                                ...
                                <div class="bg-base-200 rounded-lg p-2 flex justify-between items-center">
                                    <div>
                                        <div class="text-xs opacity-50">İptal</div>
                                        <div class="text-error text-sm font-medium">
                                            {{ $branch['cancelled_count'] }}
                                        </div>
                                    </div>
                                ...
                                <div class="bg-base-200 rounded-lg p-2 flex justify-between items-center">
                                    <div>
                                        <div class="text-xs opacity-50">Bekleyen</div>
                    ...
                    <div class="flex items-center gap-3">
                        <div class="flex items-center gap-1.5">
                            <span class="text-primary text-sm font-medium">
                                {{ collect($selectedBranchesData)->sum('total_appointments') }}
                            </span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="text-success text-sm font-medium">
                                {{ collect($selectedBranchesData)->sum('completed_count') }}
                            </span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="text-error text-sm font-medium">
                                {{ collect($selectedBranchesData)->sum('cancelled_count') }}
                            </span>
                        </div>
                        <div class="flex items-center gap-1.5">
                            <span class="text-warning text-sm font-medium">
                                {{ collect($selectedBranchesData)->sum('pending_count') }}
                            </span>
                        </div>
                    </div>
                </div>
