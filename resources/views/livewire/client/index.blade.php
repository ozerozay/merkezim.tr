...
<div>
    ...
    <x-alert title="Değerlendirmediğiniz randevu bulunuyor."
        description="Görüşleriniz bizim için değerli, bir dakikanızı ayırıp" icon="tabler.star" class="alert-info mb-2">
        <x-slot:actions>
            <x-button label="Değerlendir" />
        </x-slot:actions>
    </x-alert>
    <x-alert title="1500₺ gecikmiş ödemeniz bulunuyor." description=" Kredi kartı veya havale ile hemen ödeyebilirsiniz."
