...
<x-nav>
    ...
    {{-- Right side actions --}}
    <x-slot:actions>
        <x-button label="Fiyatlandırma" icon="o-envelope" link="###" class="btn-ghost btn-sm" responsive/>
        <x-button label="Giriş" icon="o-bell" link="###" class="btn-ghost btn-sm" responsive/>
    </x-slot:actions>
</x-nav>
...
<x-main with-nav>
    {{-- SIDEBAR --}}
    <x-slot:sidebar drawer="main-drawer" collapse-text="Küçült" collapsible class="bg-base-100 lg:bg-inherit lg:hidden">
        {{-- MENU --}}
